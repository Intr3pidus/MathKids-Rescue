          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/divisao.png', // Coloque o caminho da sua imagem de soma aqui
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildCircleButton(context, '4', '/parabens'),
                      const SizedBox(width: 16),
                      _buildCircleButton(context, '2', '/erro'),
                      const SizedBox(width: 16),
                      _buildCircleButton(context, '7', '/erro'),
                    ],
                  ),
                ],
              ),
