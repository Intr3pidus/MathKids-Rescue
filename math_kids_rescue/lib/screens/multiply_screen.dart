          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/multiplicacao.png', // Coloque o caminho da sua imagem de soma aqui
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildCircleButton(context, '3', '/erro'),
                      const SizedBox(width: 16),
                      _buildCircleButton(context, '9', '/parabens'),
                      const SizedBox(width: 16),
                      _buildCircleButton(context, '15', '/erro'),
                    ],
                  ),
                ],
              ),
